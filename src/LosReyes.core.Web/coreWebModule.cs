    ...
    public class coreWebModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<coreDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}LosReyes.core.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<coreDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}LosReyes.core.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<coreApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}LosReyes.core.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<coreApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}LosReyes.core.Application"));
